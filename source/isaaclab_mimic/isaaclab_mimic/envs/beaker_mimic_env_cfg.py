...
from isaaclab_tasks.manager_based.manipulation.lift.config.franka.ik_rel_cfg_vial_simplified import VialSimplePickPlaceEnvCfg


@configclass
class BeakerMimicEnvCfg(VialSimplePickPlaceEnvCfg, MimicEnvCfg):
    """
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "vial_pick_place_isaac_lab_task_D0"
