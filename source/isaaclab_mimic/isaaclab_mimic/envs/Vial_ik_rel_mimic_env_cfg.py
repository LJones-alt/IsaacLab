...
from isaaclab_tasks.manager_based.manipulation.lift.config.franka.ik_rel_cfg_vial import VialPickPlaceEnvCfg


@configclass
class VialIKRelMimicEnvCfg(VialPickPlaceEnvCfg, MimicEnvCfg):
    """
