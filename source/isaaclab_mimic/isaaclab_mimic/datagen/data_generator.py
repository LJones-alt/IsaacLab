...
class DataGenerator:
    ...
    def __init__(
       ...
       # self.subtask_configs[-1].subtask_term_offset_range[0] = 0
        #self.subtask_configs[-1].subtask_term_offset_range[1] = 0
     #   print(f"subtask config : {self.subtask_configs[-1].subtask_term_offset_range[0] }")
