...
from isaaclab_tasks.manager_based.manipulation.vial_actions.mdp import franka_stack_events
from isaaclab_tasks.manager_based.manipulation.vial_actions.vial_instance_randomize_env_cfg import VialInstanceRandomizeEnvCfg
)
...
@configclass
class VialInstanceRandomizeEnvCfg(VialInstanceRandomizeEnvCfg):
