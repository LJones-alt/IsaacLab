...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        object = ObsTerm(func=mdp.object_obs, params={"object_cfg": SceneEntityCfg("object")})
...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        ...
        mode="reset",
        params={
            "pose_range": {"x": (0.2,0.2), "y": (0.0, 0.0), "z": (0.0, 0.0)},
            "velocity_range": {},
...
class RewardsCfg:
    ...
    reaching_object = RewTerm(func=mdp.object_ee_distance, params={"std": 0.1, "object_cfg": SceneEntityCfg("object")}, weight=15.0)

    lifting_object = RewTerm(func=mdp.object_is_lifted, params={"minimal_height": 0.2, "object_cfg": SceneEntityCfg("object")}, weight=15.0)

    object_goal_tracking = RewTerm(
        func=mdp.object_goal_distance,
        params={"std": 0.3, "minimal_height": 0.04, "command_name": "object_pose", "object_cfg": SceneEntityCfg("object")},
        weight=10.0,
    )

    object_goal_tracking_fine_grained = RewTerm(
        func=mdp.object_goal_distance,
        params={"std": 0.05, "minimal_height": 0.04, "command_name": "object_pose", "object_cfg": SceneEntityCfg("object")},
        weight=5.0,
    )
...
class TerminationsCfg:
    ...
    success = DoneTerm(func=mdp.object_is_lifted, params={"minimal_height": 0.2})
    #success = DoneTerm(func=mdp.object_reached_goal, params={"object_cfg" : SceneEntityCfg("object")})
